...
import Styles from './Styles/FinraViewStyle'
...
class FinraView extends React.Component {
  ...
  render = () => {
  	const rule = this.props.rule === 5130 ? this.render5130() : this.render5131()
    return (
