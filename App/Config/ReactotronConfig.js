...
if (Config.useReactotron) {
  Reactotron
    .configure({
      // The next line is required for Android only, so uncomment it and comment the line after it
      // host: '10.0.2.2', // default is localhost (on android don't forget to `adb reverse tcp:9090 tcp:9090`)
      // The next line is required for iOS only to uncomment it and comment the line above
      host: scriptHostname,
